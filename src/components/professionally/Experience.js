...
function Experience () {
    ...
    const experiences = [
      ...
      },
      {
        ...
        responsibilities: [
          "To date, very few oral medications have been developed to treat COVID-19, highlighting the critical need for more oral treatments. Our research will focus on discovering novel inhibitors for the SARS-CoV-2 main protease using AI/ML computational tools.",
